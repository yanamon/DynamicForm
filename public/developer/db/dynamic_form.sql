...
(218,87,'<div id=card-input-0 data-required=Yes data-key=nama_barang data-id=0 class=card-input><div class=form-group><label>Nama Barang</label><input class=form-control type=text name=input_value[0] placeholder=text required><input type=hidden name=input_label[0] value=nama_barang></div></div>','nama_barang','2019-11-27 08:53:46','2019-11-27 08:53:46',NULL),
(219,87,'<div id=card-input-2 data-required=Yes data-key=sad data-id=2 class=card-input><div class=form-group><label>das</label><select class=select2 name=input_value[2]><option data-is-empty=1>-- Choose das --</option><option>a</option><option>v</option><input type=hidden name=input_label[2] value=sad></div></div>','sad','2019-11-27 08:53:46','2019-11-27 08:53:46',NULL),
(220,87,'<div id=card-input-3 data-required=Yes data-key=foto_barang data-id=3 class=card-input><div class=form-group><label>Foto Barang</label><input class=form-control type=file name=input_value[3] placeholder=file required><input type=hidden name=input_label[3] value=foto_barang></div></div>','foto_barang','2019-11-27 08:53:46','2019-11-27 08:53:46',NULL),
(226,89,'<div id=card-input-0 data-required=Yes data-key=tags data-id=0 class=card-input><div class=form-group><label>Tags</label><div class=check><div class=form-check><label class=form-check-label><input required type=checkbox name=input_value[0][0] value=food>food</label></div><div class=form-check><label class=form-check-label><input required type=checkbox name=input_value[0][1] value=animal>animal</label></div><div class=form-check><label class=form-check-label><input required type=checkbox name=input_value[0][2] value=travel>travel</label></div></div><input type=hidden name=input_label[0] value=tags></div></div>','tags','2019-11-30 10:17:31','2019-11-30 10:17:31',NULL),
(241,99,'<div id=card-input-0 data-required=Yes data-key=asdad data-id=0 class=card-input><div class=form-group><label>ads</label><input readonly data-toggle=modal data-target=#table-modal-0 class=form-control type=tablemodal placeholder=\'Click to Set This Input\' required><div class=modal id=table-modal-0><div class=\'modal-dialog modal-xl modal-dialog-scrollable\'>                    <div class=modal-content>                        <div class=modal-header>                            <h4 class=modal-title>Select Data</h4>                            <button type=button class=close data-dismiss=modal>×</button>                        </div>                        <div class=modal-body>                            <div class=table-responsive>                                <table id=example class=table>                                    <thead class=thead-dark>                                        <th></th><th>input_type</th><th>html</th><th>is_option</th><th>created_at</th><th>updated_at</th></thead>                                    <tbody>                                        <tr><td><center><input type=radio name=input_value[0] value=1></center></td><td>Text</td><td>text</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=2></center></td><td>Number</td><td>number</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=3></center></td><td>Multiple Choice</td><td>radio</td><td>1</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=4></center></td><td>Checkbox</td><td>checkbox</td><td>1</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=5></center></td><td>Dropdown</td><td>dropdown</td><td>1</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=6></center></td><td>File Upload</td><td>file</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=7></center></td><td>Date</td><td>date</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=8></center></td><td>Time</td><td>time</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=9></center></td><td>Datetime</td><td>datetime-local</td><td>0</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr><tr><td><center><input type=radio name=input_value[0] value=10></center></td><td>Table Modal</td><td>tablemodal</td><td>2</td><td>2019-10-09 21:34:20</td><td>2019-10-09 21:34:20</td></tr>                                    </tbody>                                </table>                            </div>                        </div>                        <div class=modal-footer>                            <button data-dismiss=modal id=btn-export type=button class=\'btn btn-danger\'>Submit</button>                        </div>                    </div>                </div>            </div>            <script>$(\'.table\').DataTable();</script><input type=hidden name=input_label[0] value=asdad></div></div>','asdad','2019-12-02 19:53:41','2019-12-02 19:53:41',NULL),
(242,85,'<div id=card-input-0 data-required=Yes data-key=kode_barang data-id=0 class=card-input><div class=form-group><label>Kode Barang</label><input class=form-control type=text name=input_value[0] placeholder=text required><input type=hidden name=input_label[0] value=kode_barang></div></div>','kode_barang','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL),
(243,85,'<div id=card-input-1 data-required=Yes data-key=nama_barang data-id=1 class=card-input><div class=form-group><label>Nama Barang</label><input class=form-control type=text name=input_value[1] placeholder=text required><input type=hidden name=input_label[1] value=nama_barang></div></div>','nama_barang','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL),
(244,85,'<div id=card-input-2 data-required=Yes data-key=harga_barang data-id=2 class=card-input><div class=form-group><label>Harga Barang</label><input class=form-control type=text name=input_value[2] placeholder=text required><input type=hidden name=input_label[2] value=harga_barang></div></div>','harga_barang','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL),
(245,85,'<div id=card-input-3 data-required=Yes data-key=foto_barang_1 data-id=3 class=card-input><div class=form-group><label>Foto Barang 1</label><input class=form-control type=file name=input_value[3] placeholder=file required><input type=hidden name=input_label[3] value=foto_barang_1></div></div>','foto_barang_1','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL),
(246,85,'<div id=card-input-4 data-required=Yes data-key=foto_barang_2 data-id=4 class=card-input><div class=form-group><label>Foto Barang 2</label><input class=form-control type=file name=input_value[4] placeholder=file required><input type=hidden name=input_label[4] value=foto_barang_2></div></div>','foto_barang_2','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL),
(247,85,'<div id=card-input-5 data-required=Yes data-key=id_jenis_barang data-id=5 class=card-input><div class=form-group><label>Jenis Barang</label><input readonly data-toggle=modal data-target=#table-modal-5 class=form-control type=tablemodal placeholder=\'Click to Set This Input\' required><div class=modal id=table-modal-5><div class=\'modal-dialog modal-xl modal-dialog-scrollable\'>                    <div class=modal-content>                        <div class=modal-header>                            <h4 class=modal-title>Select Data</h4>                            <button type=button class=close data-dismiss=modal>×</button>                        </div>                        <div class=modal-body>                            <div class=table-responsive>                                <table id=example class=table>                                    <thead class=thead-dark>                                        <th></th><th>nama_jenis_barang</th></thead>                                    <tbody>                                        <tr><td><center><input type=radio name=input_value[5] value=1></center></td><td>Daging</td></tr><tr><td><center><input type=radio name=input_value[5] value=2></center></td><td>Elektronik</td></tr><tr><td><center><input type=radio name=input_value[5] value=3></center></td><td>Sayuran</td></tr><tr><td><center><input type=radio name=input_value[5] value=4></center></td><td>Kebersihan</td></tr><tr><td><center><input type=radio name=input_value[5] value=5></center></td><td>Alat Tulis</td></tr><tr><td><center><input type=radio name=input_value[5] value=6></center></td><td>Buku</td></tr>                                    </tbody>                                </table>                            </div>                        </div>                        <div class=modal-footer>                            <button data-dismiss=modal id=btn-export type=button class=\'btn btn-danger\'>Submit</button>                        </div>                    </div>                </div>            </div>            <script>$(\'.table\').DataTable();</script><input type=hidden name=input_label[5] value=id_jenis_barang></div></div>','id_jenis_barang','2019-12-02 19:59:24','2019-12-02 19:59:24',NULL);
...
(89,21,'Form1',NULL,'form1','2019-11-30 10:17:31','2019-11-30 10:17:31'),
(99,21,'asdsd',NULL,'adadasds','2019-12-02 19:53:41','2019-12-02 19:53:41');
...
(21,5,'Project3','pguozkqfb6vn8w9','dw5h7xegfdm356a','apa_LdNqwrsAAAAAAAABfUSb9a8JZ5YuUMOK9FWi3oQp2AnPKyl8bARec7pjPns2','2019-11-30 10:16:10','2019-11-30 10:16:10');
