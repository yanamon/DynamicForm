...
<script>
    function validate() {
        ...
        if (!formTitle) {
            ...
            alert("Sub Form Name is required");
        }
        else{
            $.ajax({
                url: "/ajax-check-sub-form-name",
                method : 'post',
                data:{
                ...
                success:function(data){
                    ...
                    else alert("Sub Form Name already used in your form");
                },
            });
        }
    }
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div id="card" class="col-md-8 shadow-sm" style="padding-bottom : 18px;">
            <div>
                ...
                @endif
                <form action="/store-sub-form" method="POST" id="dynamic-form" class="dynamic-form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="json-identifier">
                                    <div class="form-group">
                                        <label for="usr">Sub Form Name:</label>
                                        <input id="subFormName" class="form-control" type="text" name="sub_form_name" placeholder="May only contain letters, numbers, dashes, underscores"> 
                                    </div>
                                    <!-- <div class="form-group">
